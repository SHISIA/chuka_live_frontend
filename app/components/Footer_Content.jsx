...
export default function WorkWithUs() {
	return (
		<footer className="px-4 divide-y  dark:text-black">
			<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0" style={{ backgroundColor: "#F5F5F5" }}>
				...
				<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
					...
					<div className="space-y-3">
						<div className="uppercase font-bold dark:text-gray-900 justify-center text-start">Social media</div>
			...
			<div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Chuka Live. All rights reserved.</div>
		</footer>
	)
}