    ...
    <AnimatedLayout>
      <div className="flex justify-center items-center bg-gray-100 font-[sans-serif] h-full md:min-h-screen p-4">
        <div className="grid justify-center max-w-md mx-auto">
          <div>
            <img src="../images/friendly.webp" className="w-full object-cover rounded-2xl" alt="login-image" />
          </div>

          <form className="bg-white rounded-2xl p-6 -mt-24 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
            <div className="mb-12" onClick={()=> router.push('/home')}>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
              <div className="flex items-center">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 shrink-0 text-white focus:ring-black border-gray-300 rounded" />
                <label htmlFor="remember-me" className="text-gray-800 ml-3 block text-sm">
                  Remember me
                </label>
              </div>
              <div>
                <a href="jajvascript:void(0);" className="text-black text-sm font-semibold hover:underline">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <div className="mt-12">
              <button type="button" className="w-full py-2.5 px-4 text-sm font-semibold tracking-wider rounded-md text-white bg-slate-900 hover:bg-white hover:text-black border hover:border-black focus:outline-none">
                Sign in
              </button>
              <p onClick={()=> router.push('/signUp')} className="text-sm text-center mt-6">Don't have an account <a href="javascript:void(0);" className="text-goldenYellow font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </div>

            <div className="flex justify-center items-center my-4 gap-2">
              <hr className="my-6 border-gray-300 sm:w-32 w-20" />
              <p>Sign in with</p>
              <hr className="my-6 border-gray-300 sm:w-32 w-20" />
            </div>
